...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/19 11:36:36 by larmogid          #+#    #+#             */
/*   Updated: 2023/05/01 22:36:03 by larmogid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/fdf.h"

static int	col_gradient(t_color *color, float progress);
...
int	get_color(t_color *color, int i_line, int line_size)
{
	...
	return (col_gradient(color, progress));
}
...
t_color	*col_init(t_point start, t_point end)
{
	t_color	*color;
...
t_color	*col_management_init(int min_color, int max_color)
{
	t_color	*color;
